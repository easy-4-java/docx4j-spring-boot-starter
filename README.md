...
**Spring Boot Starter for docx4j-template-bom**
...
**docx4j-spring-boot-starter** is a Spring Boot starter that integrates **docx4j-template-bom** for applications using docx4j-template-bom. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume docx4j-template-bom capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using docx4j-template-bom |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for docx4j-template-bom |
| JDK | `17` |
| Coordinates | `io.github.easy4j:docx4j-spring-boot-starter:3.3.x.20251227-SNAPSHOT` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers docx4j-template-bom beans automatically |
